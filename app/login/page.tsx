        ...
        <div className="flex flex-col gap-3 mb-6">
          <button
            ...
            className="
              ...
              hover:bg-white/10 hover:text-white transition-all font-medium text-sm
            "
          >
            <GitHubIcon />
        ...
        <form onSubmit={handleEmailAuth} className="flex flex-col gap-3">
          <input
            ...
            className="
              ...
              outline-none focus:border-white/25 focus:bg-white/8 transition-all
            "
          />
          <input
            type="password"
          ...
          {message && (
            <p className="text-emerald-400/80 text-xs px-1">{message}</p>
          )}
          ...
          <button
            ...
            disabled={loading}
            className="
              w-full py-3 rounded-xl bg-white text-black font-semibold text-sm
